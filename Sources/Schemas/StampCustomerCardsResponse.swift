...
public struct StampCustomerCardsResponse: Codable, Hashable, Sendable {
    /// Parent store ID
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.availableRewards = try container.decode([String].self, forKey: .availableRewards)
    ...
    public func encode(to encoder: Encoder) throws -> Void {
        ...
        try container.encode(self.availableRewards, forKey: .availableRewards)
